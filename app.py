...
def journeybuilder_execute():
    ...
    if request.method == EXECUTE_METHOD:
        ...
        if not is_prod:
            ...
            decrypted_token = {"inArguments": [{"tokens": {"token": "0bICaQjRzb5eVIj1GdBUzh6q0PdVXF3oaLxCxQzEyfo1rhla7kABc4H0cPjG-eR9rA2ZvY_WS6BjbEyn1UgVOKGSq0ZK27z8qMxHmSLpUQ9KTA8-wnNVzXKtT9JNnsgmYUEHMO_MmbPrF1XYOyreU_jhPAiMDKZ_tlf_37LtUSYpdlwOOTc2FWhYTNb-soYTTqd4vZI4xv2w_K9qkY1HuKpE9ApaMbmy2ujZPDZrzCzOJE_-rMUQfZN_LFnzL5_Uhe1UWfj_jlGIWiE0Ohpu1CQ", "fuel2token": "4KgCwn7Y2K25y4eeMOt61LU6", "expires": 1595580458304, "stackKey": "S4"}, "contactIdentifier": "rmorris.10000.0000@gmail.exacttargettest.com", "emailAddress": "rmorris.10000.0000@gmail.exacttargettest.com", "is_template": "ProductPurchase", "is_event_mappings": {"user_id": "UserID", "source": "", "event_date": "EventDate", "order_id": "OrderID", "currency": "Currency", "line_items": "LineItems"}, "de_field_mappings": {"EmailAddress": "rmorris.10000.0000@gmail.exacttargettest.com", "FirstName": "Rachel", "LastName": "Morris", "UserID": "100000008", "Action": "Made Purchase", "EventDate": "6/8/2020 12:00:00 AM", "EventID": "2", "OrderID": "100022", "Currency": "USD", "LineItems": "[{_id: freedom-card,price: 25.00,quantity: 2}, {_id: cloud-travel-card,price: 25.00,quantity: 1}]"}}], "outArguments": [{"SegmentMembership": ""}], "activityObjectID": "85461159-0737-48a3-80cf-65de13f616bc", "journeyId": "83d815ee-c350-4466-ac1f-41a919d9f3fe", "activityId": "85461159-0737-48a3-80cf-65de13f616bc", "definitionInstanceId": "a5d5e1a8-c3e2-4884-a582-3f4806b40501", "activityInstanceId": "a48901d6-37d0-441d-a831-7c8c5a971f9a", "keyValue": "rmorris.10000.0000@gmail.exacttargettest.com", "mode": 0}
